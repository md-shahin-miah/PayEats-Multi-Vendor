      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            trailing: Text('\$ 305', style: amountStyle),
          ),
          Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: foodieOrange!),
          ...
          ListTile(
            ...
            trailing: Text('\$ 540', style: amountStyle),
          ),
          UIHelper.verticalSpaceMedium(),
          SizedBox(
            height: 45.0,
